...
<section class="space-y-6">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->isNotEmpty()" focusable>
        <form wire:submit="deleteUser" class="p-6 dark:bg-gray-900">
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-full sm:w-3/4 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100"
            ...
            <div class="mt-6 flex justify-end gap-3">
                <x-secondary-button x-on:click="$dispatch('close')" class="dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700">
                    {{ __('Cancelar') }}
                </x-secondary-button>
